...
public class SearchAdapter extends BaseAdapter implements Filterable {
    ...
    private List<Story> suggestions;
    private Drawable suggestionIcon;
    private LayoutInflater inflater;
    private boolean ellipsize;

    public SearchAdapter(Context context, List<Story> suggestions) {
        inflater = LayoutInflater.from(context);
        data = new ArrayList<>();
        this.suggestions = suggestions;
    }

    public SearchAdapter(Context context, List<Story>suggestions, Drawable suggestionIcon, boolean ellipsize) {
        inflater = LayoutInflater.from(context);
        data = new ArrayList<>();
        this.suggestions = suggestions;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Story currentListData = (Story) getItem(position);

        viewHolder.textView.setText(currentListData.getValue().toString());
        if (ellipsize) {
