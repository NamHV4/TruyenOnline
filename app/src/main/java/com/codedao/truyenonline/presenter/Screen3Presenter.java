...
import static com.codedao.truyenonline.base.Config.isOnllie;
import static com.codedao.truyenonline.model.ApiConnect.GET_SUCCSES_LIST_STORY_BYTYPE;
...
public class Screen3Presenter  {
    private static final String TAG = "Screen3Presenter";
    ...
    public Screen3Presenter(Context context, int idTheLoai, IScreen3View mIScreen3View) {
        this.mContext = context;
        this.mIScreen3View = mIScreen3View;
        mApiConnect = new ApiConnect();
        mIdTheLoai = idTheLoai;
    ...
    public void init() {
        ...
        if (isOnllie) {
            ...
            mApiConnect.getStoryByType(""+mIdTheLoai);
        } else {
            mTruyenDatabaseHepler = new TruyenDatabaseHepler(mContext);
            //initDatabase();
            mTruyens = mTruyenDatabaseHepler.getListTruyenByIdType(mIdTheLoai);
        }
    ...
    public void onMessageEvent(MessageEvent event) {
        switch (event.getmEvent()) {
            case GET_SUCCSES_LIST_STORY_BYTYPE:
                mTruyens = event.getmTruyens();
                Log.d(TAG, "onMessageEvent: Nam Ocs CHos"+mTruyens.size());
                mIScreen3View.onDataStateChange();
//                mTruyenAdapter = new TruyenAdapter(mTruyens, mContext, this);
//                mTruyenAdapter.notifyDataSetChanged();
